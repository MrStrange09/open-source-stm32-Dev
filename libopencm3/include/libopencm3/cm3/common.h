...
#define MMIO32(addr)		(*(volatile uint32_t *)(addr)) //volatile tell the compiler not to optimise it/ cache the value/every read is actually read and every write is actually write
